...
<form:form modelAttribute="qBoardVO" method="post"  action="${cPath }/board/qnaBoardView">	
<security:csrfInput/>
	<table class="table table-bordered">
		<form:input type="hidden" path="boardNo" class="form-control" readonly="true" />
	...
	<tr>
		...
		<td>
			<TEXTAREA rows="10" cols="220" name="boardContent">${qBoardVO.boardContentDisplay }</TEXTAREA>
		</td>
	</tr>
	</table>
