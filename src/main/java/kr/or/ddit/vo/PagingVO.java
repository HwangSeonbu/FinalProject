...
public class PagingVO<T> {
	...
	public String getPagingHTML() {
		...
		if(startPage > blockSize) {
			html.append(
				String.format(PTRN, (startPage - blockSize), "<<")
			);
		}
	...
	public String getPagingHTMLBS() {
		...
		html.append(
			String.format(BSPTRN, activeOrDisable, (startPage - blockSize), "<<")
		);
		if(endPage>totalPage) {
			endPage = totalPage;
		}
		...
		html.append(
			String.format(BSPTRN, activeOrDisable, (endPage + 1), ">>")
		);
		html.append("</ul>");
		html.append("</nav>");
		return html.toString();
