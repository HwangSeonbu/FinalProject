...
public class EnrollViewConroller {
	...
	public String enrollView(Authentication authentication, Model model) {
		MemberVO authMember = ((MemberVOWrapper)authentication.getPrincipal()).getRealUser();
		StudentEnrollVO enrollVo = service.studentEnrollView(authMember.getUserNo());
	...
	public String enrollPayList( Model model, Authentication authentication) {
